...
|---------|-------------|------|-------|-----------|
| [**Septum**](https://github.com/byerlikaya/Septum) | Privacy-first AI middleware with local PII detection, approval gate, and automatic de-anonymization. Query your documents with any LLM — GDPR, KVKK, HIPAA ready. | ![Python](https://img.shields.io/badge/-Python-3572A5?style=flat-square&logoColor=white) | ⭐ 6 | 2026-04-24 |
